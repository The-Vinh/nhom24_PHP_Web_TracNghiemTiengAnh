    ...
    <div class="col-lg-6 col-lg-push-3" style="min-height: 500px; background-color: white;">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-lg-push-10">
                ...
                &frasl;<div id="total_que" style="float: left;"></div>
                <div style="float: left;"></div>
            </div>
            <div class="row" style="margin-top: 30px;">
                <div class="row">
                    <div id="load_questions" class="col-lg-10 col-lg-push-1" style="min-height: 300px; background-color: white">
...
<script type="text/javascript">
    function radioclick(radiovalue, question_no) {
        ...
        xmlhttp.open("GET", "forajax/save_in_session.php?questionno=" + question_no + "&value1" + radiovalue, true);
        xmlhttp.send(null);
    }
