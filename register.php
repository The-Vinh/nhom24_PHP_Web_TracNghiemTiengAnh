                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            ...
                            <div class="text-center">
                                <a class="btn btn-success loginbtn" href="./login.php">Back login</a>
                            </div>
                            <div id="success" class="alert alert-success" style="margin-top: 10px; display: none;">
                                <strong>Thành công!</strong> Đăng ký tài khoảng thành công!
                            </div>
                            <div id="failure" class="alert alert-danger" style="margin-top: 10px; display: none;">
                                <strong>Đã tồn tại!</strong> Username đã tồn tại
                            </div>
                        </form>
                    </div>
                </div>
